...
if (isset($_POST['send'])) {
    ...
    $sql = "INSERT INTO tblbloodrequirer (BloodDonarID, name, EmailId, ContactNumber, BloodRequirefor, Message, Status) VALUES (:cid, :name, :email, :contactno, :brf, :message, 0)";
                ...
                <div class="col-lg-7 contact-right-w3l">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="d-flex space-d-flex">
                            ...
                            <div class="form-group grid-inputs">
                                <label for="recipient-name" class="col-form-label">Blood Required For</label>
